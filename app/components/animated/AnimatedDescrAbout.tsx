...
const AnimatedDescrAbout: FC = (): JSX.Element => (
  ...
  >
    ...
    what.... I started to learn HTML and CSS on my own, I started to understand
    programming languages ​​and their frameworks. But today there are so many
    programming languages ​​that I was confused about which technology does
    what. The decision was to go to the courses in order to gain basic knowledge
    on the basis of which it will be easier to form your further technology
    stack. <span className="text-accent">Why javaScript?</span> In general, my
    desire was to understand how WEB works in general. After surfing a little on
    the Internet, found out that JS is not difficult for a beginner and a lot of
